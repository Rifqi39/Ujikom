            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php
                            if($_SESSION ['level'] == 'admin'){
                            ?>
<td><a href="hapus_kategori.php?kategoriID=<?php echo $data['kategoriID'];?>" class="btn btn-danger" onClick =  "return confirm ('Yakin Ingin Hapus Kategori?')" >Hapus</a></td><?php } ?>
                </tr>
                <?php
                    }
                ?>
