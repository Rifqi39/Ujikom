...
<div class="container-fluid">
    ...
    <?php
    $id = $_GET['bukuID'];
    $judul = mysqli_query($koneksi, "SELECT * FROM buku WHERE bukuID='$id'");
    while($buku = mysqli_fetch_array($judul)){
   ?>
    <form action="aksi_pinjam.php?bukuID=<?=$buku['bukuID']?>" method="post">
        <div class="row">
            <div class="card">
            <div class="row mb-3">
                    <div class="col-md-2">
                ...
                <div class="row mb-3">
                    <div class="col-md-2">Judul</div>
                        <div class="col-md-8">
                            <input type="text" name = "bukuID" value="<?php echo $buku['judul']; ?>" readonly>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-8">
                    <input type="number" name="jumlah" placeholder="Jumlah Buku...">
                        </div>
                </div>
                <div class="row mb-3">
