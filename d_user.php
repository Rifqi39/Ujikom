...
<div class="container-fluid">
  ...
  <div class="sidebar border border-right col-md-3 col-lg-2 p-0  bg-body-tertiary">
    ...
    <div class="container">
        <table class = "table table-striped table-sm" cellpadding= "2" align = "center" border = "1">
            <thead>
                <tr>
                    <th>No</th>
                    <th>ID User</th>
            ...
            <input type="submit" value="Tambah Pengelola">
        </form></th>
        <?php
        }
          ?>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php
                            if($_SESSION ['level'] == 'admin'){
                            ?>
<td><a href="hapus_user.php?userID=<?php echo $data['userID'];?>" class="btn btn-danger" onClick =  "return confirm ('Yakin Ingin Hapus User?')" >Hapus</a></td><?php } ?>
                </tr>
                <?php
                    }
                ?>
