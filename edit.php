...
<div class="container-fluid">
    ...
    <div class="sidebar border border-right col-md-3 col-lg-2 p-0  bg-body-tertiary">
      <div class="canvas  " tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        <div class="offcanvas-header">
        <div>
              <a class="btn btn-outline-primary">
               Nama: Rifqi Surya Putra
              </a>
        </div>
        </div>
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            ...
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2" href="d_buku.php">
    ...
    <h2>Edit Buku</h2>
        ...
        <table class = "table table-striped table-sm">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="judul" value="<?php echo $d['judul']; ?>" required autofocus>
                    <input type="hidden" name="bukuID" value="<?php echo $d['bukuID']; ?>" required autofocus>
                </td>
            </tr>
            <tr>
                <td width="150">Penulis</td>
                <td>
                    <input type="text" name="penulis" value="<?php echo $d['penulis']; ?>" required autofocus>
                </td>
            </tr>
            <tr>
                <td width="150">Penerbit</td>
                <td>
                    <input type="text" name="penerbit" value="<?php echo $d['penerbit']; ?>" required autofocus>
                </td>
            </tr>
            <tr>
                <td width="150">Tahun Terbit</td>
                <td>
                    <input type="text" name="tahunterbit" value="<?php echo $d['tahun_terbit']; ?>" required autofocus>
                </td>
            </tr>
            <tr>
                <td width="150">Sinopsis</td>
                <td>
                    <input type="text" name="sinopsis" value="<?php echo $d['sinopsis']; ?>" required autofocus>
                </td>
            </tr>
            <tr>
                <td width="150">Stok</td>
                <td>
                    <input type="text" name="stok" value="<?php echo $d['stok']; ?>" required autofocus>
                </td>
            </tr>
            <tr>
                <td colspan = "2">
                    <input type="submit" name ="submit" value="Edit" required> <input type="reset" value="Reset">
                </td>
            </tr>
            </form>
        </table>
