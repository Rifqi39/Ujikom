    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <table class = "table table-striped table-sm">
            ...
            ?>
                    ...
                    <th>Tahun Terbit</th>
                    <th>Stok</th>
                    <th><a href="tambah.php" class="btn btn-primary">Tambah Buku</a></th>
        <?Php
        }else{
      ...
      ?>
            ...
            <?php
                ...
                <tr>
                    ...
                    <td><a href="peminjaman.php?bukuID=<?php echo $data['bukuID'];?>" class="btn btn-primary">Pinjam</a><a href="detail.php?bukuID=<?php echo $data['bukuID'];?>" class="btn btn-secondary">Detail</a>
                </tr>
                <?php
                    }
                ?>
